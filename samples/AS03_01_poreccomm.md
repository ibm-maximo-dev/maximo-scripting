# Automation script to create a custom action launch point 

## Custom action launch point: PORECCOMM
    Called from Escalation PORECESC com.ibm.tivoli.maximo.script.ScriptAction
    PORECCOMM,PORECCOMM,PORECCOMM
    PO.LASTRECDATE is a custom attribute to reflect latest receipt date (MATREC or SERVREC)

This sample script was written for Maximo Asset Management version 7.5.0.10.
...
# Defining the sendComm function
...
### SQL to prepare the environment to allow the automation scripting to work for this function
